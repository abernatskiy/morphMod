...
generateFromOneBase() {
	...
	generateOneScript "${base_script}" 3 125 1 'shortq' '03:00:00' 2
	generateOneScript "${base_script}" 5 625 5 'shortq' '03:00:00' 8
	generateOneScript "${base_script}" 10 2000 10 'workq' '30:00:00' 100
}
