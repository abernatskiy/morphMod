...
generateOneScript() {
	...
	cat "${base_script}.py" | sed \
		...
		-e "s/'timeStep': [\.0-9]*/'timeStep': ${simulation_time_step}/" > "autoscripts/${base_script}_N${num_segments}.py"
}
...
generateFromOneBase() {
	...
	generateOneScript "${base_script}" 3 125 1 'shortq' '03:00:00' 2 '3.0' '0.05'
	generateOneScript "${base_script}" 5 625 5 'shortq' '03:00:00' 8 '3.0' '0.05'
	generateOneScript "${base_script}" 10 1000 10 'workq' '30:00:00' 100 '6.0' '0.1'
}
